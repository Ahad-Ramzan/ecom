...
const LeftSection = () => {
  return (
    <div className="bg-[#F8F8FD] p-6 rounded-md text-white">
      {/* Contact Information */}
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <h4 className="text-[18px] leading-5 text-_darktext">
            Contact Information
          </h4>
        ...
        <input
          ...
          className={`${lato.className} w-full bg-transparent border-b-[2px] border-[#BFC6E0] text-_darktext placeholder:text-_subtext2 py-2 mb-2 text-[14px] focus:outline-none`}
        />
